...
func (okV3Ws *OKExV3FuturesWs) TickerCallback(tickerCallback func(*types.FutureTicker)) {
	okV3Ws.tickerCallback = tickerCallback
}

func (okV3Ws *OKExV3FuturesWs) DepthCallback(depthCallback func(*types.Depth)) {
	okV3Ws.depthCallback = depthCallback
}

func (okV3Ws *OKExV3FuturesWs) TradeCallback(tradeCallback func(*types.Trade, string)) {
	okV3Ws.tradeCallback = tradeCallback
}

func (okV3Ws *OKExV3FuturesWs) KlineCallback(klineCallback func(*types.FutureKline, int)) {
	okV3Ws.klineCallback = klineCallback
}

func (okV3Ws *OKExV3FuturesWs) SetCallbacks(tickerCallback func(*types.FutureTicker),
	depthCallback func(*types.Depth),
	tradeCallback func(*types.Trade, string),
	klineCallback func(*types.FutureKline, int)) {
	okV3Ws.tickerCallback = tickerCallback
...
func (okV3Ws *OKExV3FuturesWs) getChannelName(currencyPair types.CurrencyPair, contractType string) string {
	var (
		prefix      string
		contractId  string
		channelName string
...
func (okV3Ws *OKExV3FuturesWs) SubscribeDepth(currencyPair types.CurrencyPair, contractType string) error {
...
func (okV3Ws *OKExV3FuturesWs) SubscribeTicker(currencyPair types.CurrencyPair, contractType string) error {
...
func (okV3Ws *OKExV3FuturesWs) SubscribeTrade(currencyPair types.CurrencyPair, contractType string) error {
...
func (okV3Ws *OKExV3FuturesWs) SubscribeKline(currencyPair types.CurrencyPair, contractType string, period int) error {
...
func (okV3Ws *OKExV3FuturesWs) getContractAliasAndCurrencyPairFromInstrumentId(instrumentId string) (alias string, pair types.CurrencyPair) {
